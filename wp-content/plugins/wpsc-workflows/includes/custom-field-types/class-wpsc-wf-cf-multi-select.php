...
if ( ! class_exists( 'WPSC_WF_CF_Multi_Select' ) ) :

	final class WPSC_WF_CF_Multi_Select {
		...
		public static function print( $cf, $val = array() ) {
			...
			<div class="wpsc-input-group <?php echo esc_attr( $cf->field ); ?>" data-slug="<?php echo esc_attr( $cf->slug ); ?>">
				...
				<select class="<?php echo esc_attr( $unique_id ); ?>" 
				name="actions[<?php echo esc_attr( WPSC_WF_Custom_Fields::get_action_slug( $cf->field ) ); ?>][<?php echo esc_attr( $cf->slug ); ?>][]" multiple>
					<?php
