	...
	final class WPSC_RP_Response_Delay {
		...
		public static function layout() {
			...
			<div class="wpsc-setting-header">
				<h2><?php esc_attr_e( 'Response Delay', 'wpsc-reports' ); ?></h2>
			</div>
			...
			<div class="wpsc-setting-section-body">
				...
				<table class="wpsc-rp-tbl">
					<tr>
						<th><?php esc_attr_e( 'First Response Delay (Hours)', 'wpsc-reports' ); ?></th>
						<th><?php esc_attr_e( 'Average Response Delay (Hours)', 'wpsc-reports' ); ?></th>
					</tr>
					<tr>
						<td class="frd"></td>
						<td class="ard"></td>
