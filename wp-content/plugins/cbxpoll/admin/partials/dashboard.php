    ...
    <div class="cbx-backend_container_header">
        <div class="cbx-backend_wrapper cbx-backend_header_wrapper">
            <div class="menu-heading">
                <img title="CBX Poll - Helps & Updates"
                     src="<?php echo CBX_POLL_PLUGIN_ROOT_URL.'assets/images/icon_log.svg'
                     ?>" alt="CBX Poll - Helps & Updates" width="32" height="32">
                <h2 class="wp-heading-inline wp-heading-inline-setting">
                    <?php esc_html_e('CBX Poll - Helps & Updates', 'cbxpoll'); ?>
                </h2>
            </div>
            <a href="<?php echo admin_url().'edit.php?post_type=cbxpoll&page=cbxpollsetting' ?>" class="button button-primary
            save-settings"> <?php esc_html_e('Go to Settings', 'cbxpoll'); ?><img
            ...
            <div class="cbx-backend-row">
                <div class="cbx-backend-col col-xs-12 col-md-6 text-xs-left">
                                        ...
                                        <div class="feature-card-body static">
                                            <div class="feature-card-header">
                                                <a href="<?php echo esc_url($plugin_url); ?>"
                                                   target="_blank"> <img
                                                            src="https://codeboxr.com/wp-content/uploads/productshots/8171-profile.png"
                                                            alt="CBX poll for WordPress"/> </a>
                        ...
                        <div class="content">
                            <div class="cbx-backend-settings-row">
                                <p>
                                    ...
                                    <?php esc_html_e('Buddypress', 'cbxpoll'); ?></p>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <p>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
                                    ...
                                    <?php esc_html_e('myCred', 'cbxpoll'); ?></p>
                            </div>
                        </div>
                    ...
                    <div class="cbx-backend-card dashboard-wp-plugin">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e('Other WordPress Plugins', 'cbxpoll'); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            <?php
                ...
                <div class="cbx-backend-col col-xs-12 col-md-6 text-xs-left">
                    ...
                    <div class="cbx-backend-card dashboard-support">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e('Help & Supports', 'cbxpoll'); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            <div class="cbx-backend-settings-row">
                                <a href="https://codeboxr.com/contact-us" target="_blank">
                                    ...
                                    <?php esc_html_e('Access our Premium Support', 'cbxpoll'); ?></a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="mailto:info@codeboxr.com&subject=Need%20support%20for%20CBX%20Poll"
                                   target="_blank">
                                    ...
                                    <?php esc_html_e('Quick Support (Email)', 'cbxpoll'); ?></a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="<?php echo esc_url($plugin_url); ?>" target="_blank">
                                    ...
                                    <?php esc_html_e('CBX Poll Plugin Information', 'cbxpoll'); ?> </a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="<?php echo esc_url($doc_url); ?>" target="_blank">
                                    ...
                                    <?php esc_html_e('Read the CBX Poll User Guide', 'cbxpoll'); ?> </a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="https://wordpress.org/support/plugin/cbxpoll/reviews/#new-post"
                                   target="_blank">
                                    <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <?php esc_html_e('Rate Our Plugin', 'cbxpoll'); ?> </a>
                            </div>
                        </div>
                    ...
                    <div class="cbx-backend-card dashboard-changelog">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e('Changelog', 'cbxpoll'); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            <div class="cbx-backend-settings-row">
                                ...
                                <ul>
                                    ...
                                    <li><strong>[improvement]</strong> Frontend UI improved.</li>
                                </ul>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <p>
                                ...
                                <ul>
                                    <li><strong>[fixed]</strong> Gutenberg block register compatibility fix for old
                                        sites.
                                    </li>
                                </ul>
                            </div>
                            <div class="cbx-backend-settings-row">
                                ...
                                <ul>
                                    <li><strong>[added]</strong> WPBakery widget added for single poll display</li>
                                    <li><strong>[improvement]</strong> Backend Style improved</li>
                                    <li><strong>[fixed]</strong> Elementor widget for Single poll display</li>
                                    <li><strong>[updated]</strong> Classic widget updated</li>
                                    <li><strong>[added]</strong> Gutenberg Block added for Single poll display</li>
                                </ul>
                            </div>
                        </div>
                    </div><!--End Changelog-->
                    ...
                    <div class="cbx-backend-card dashboard-wp-plugin">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e('Codeboxr News Updates', 'cbxpoll'); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            <?php
